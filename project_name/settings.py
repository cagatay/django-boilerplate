...
PRODUCTION = ('PRODUCTION' == os.environ.get('ENVIRONMENT', ''))
DEBUG = not PRODUCTION
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Cagatay Yuksel', 'cagatay@cagatay.co.uk'),
)
...
STATIC_ROOT = rel(PROJECT_ROOT, 'static')
